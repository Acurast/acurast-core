...
impl<T: frame_system::Config> crate::WeightInfo for WeightInfo<T> {
	...
	/// Proof Skipped: AcurastFeeManager Version (max_values: Some(1), max_size: None, mode: Measured)
	/// Storage: AcurastFeeManager FeePercentage (r:0 w:1)
	/// Proof Skipped: AcurastFeeManager FeePercentage (max_values: None, max_size: None, mode: Measured)
	fn update_fee_percentage() -> Weight {
		...
		Weight::from_parts(11_000_000, 0)
			.saturating_add(Weight::from_parts(0, 1569))
